...
# Contribute to Ory themes<!-- omit in toc -->
...
seriously. If you believe you have found a security issue in Ory themes, please
...
won't clash with Ory themes's direction. A great way to do this is via
...
- I would like to know what I am agreeing to when I contribute to Ory themes.
  Does Ory have
...
Check out [Ory themes Discussions](https://github.com/orgs/ory/discussions).
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/themes/blob/master/.github/workflows/conventional_commits.yml)
